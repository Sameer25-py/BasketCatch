...
namespace DefaultNamespace
{
    public class GameManager : MonoBehaviour
    {
        ...
        public GameObject MainMenu, SelectSpeed, Settings, Statistics, InGameUI, GameOverSprite, GameOver;

        public TMP_Text ScoreText1, BestScoreText1, ScoreText2, BestScoreText2, BestScoreText3, FruitLostScoreText;
        ...
        public static Action      IncrementFruitLostScore;
        ...
        private void OnEnable()
        {
            ...
            GameEnded += (() =>
            {
                ...
                BestScoreText3.text = _highScore.ToString();
            });
            IncrementFruitLostScore += (() =>
            {
                _fruitLostScore         += 1;
                FruitLostScoreText.text =  _fruitLostScore.ToString();
            });
        }
